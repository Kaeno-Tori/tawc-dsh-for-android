...
//!
//! Standalone threads, deliberately outside any event loop — alive
//! whenever the app process is. Implemented in Rust rather than Kotlin
//! because the data path is unix-syscall-shaped (peercred,
